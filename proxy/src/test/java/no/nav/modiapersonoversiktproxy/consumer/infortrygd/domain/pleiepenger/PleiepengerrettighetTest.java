package no.nav.modiapersonoversiktproxy.consumer.infortrygd.domain.pleiepenger;

import no.nav.modiapersonoversiktproxy.consumer.infotrygd.domain.pleiepenger.*;
