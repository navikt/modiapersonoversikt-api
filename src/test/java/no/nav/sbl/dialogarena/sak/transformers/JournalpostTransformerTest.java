...
import no.nav.sbl.dialogarena.sak.service.InnsynImplTest;
...
public class JournalpostTransformerTest {
    ...
    private static final String FNR = InnsynImplTest.PERSON_FNR;
    private static final String JOURNALPOSTID = "123";

    private static final String KOMMUNIKASJONSRETNING_INNGAAENDE = "I";
    private static final String KOMMUNIKASJONSRETNING_UTGAAENDE = "U";
    private static final String KOMMUNIKASJONSRETNING_INTERN = "N";
    ...
    public void sakUtenHovedDokumentKasterRuntimeException() {
        WSJournalpost wsJournalpost = new WSJournalpost()
                ...
                .withKommunikasjonsretning(new WSKommunikasjonsretninger().withValue(KOMMUNIKASJONSRETNING_INNGAAENDE));
    ...
    public void brukerMottattDokumentFraNAV() throws DatatypeConfigurationException {
        DokumentMetadata dokumentMetadata = journalpostTransformer.dokumentMetadataFraJournalPost(InnsynImplTest.brukerMottattDokumentFraNavMedLogiskeOgVanligeVedlegg(), FNR);
    ...
    public void navMottattDokumentFraBruker() throws DatatypeConfigurationException {
        DokumentMetadata dokumentMetadata = journalpostTransformer.dokumentMetadataFraJournalPost(InnsynImplTest.navMottattDokumentFraBruker(), FNR);
        assertThat(dokumentMetadata.getHoveddokument().getTittel(), is("Hoved.tittel"));
    }

    @Test
    public void navSendtDokumentTilEksternPart() {
        DokumentMetadata dokumentMetadata = journalpostTransformer.dokumentMetadataFraJournalPost(InnsynImplTest.navSendtDokumentTilEksternPart(), FNR);
        assertThat(dokumentMetadata.getNavn(), is(InnsynImplTest.TREDJEPERSON_NAVN));
    }

    @Test
    public void navSendtDokumentFraBedrift() throws DatatypeConfigurationException {
        DokumentMetadata dokumentMetadata = journalpostTransformer.dokumentMetadataFraJournalPost(InnsynImplTest.navMottattDokumentFraBedrift(), FNR);
        assertThat(dokumentMetadata.getNavn(), is(InnsynImplTest.BEDRIFT_NAVN));
    }

    @Test
    public void navSendtDokumentUtenAktoer() throws DatatypeConfigurationException {
        DokumentMetadata dokumentMetadata = journalpostTransformer.dokumentMetadataFraJournalPost(InnsynImplTest.navMottattDokumentFraUkjent(), FNR);
        assertThat(dokumentMetadata.getNavn(), is("ukjent"));
    }

    @Test
    public void internKategoriNotat() throws DatatypeConfigurationException {
        DokumentMetadata dokumentMetadata = journalpostTransformer.dokumentMetadataFraJournalPost(InnsynImplTest.internDokumentinfoRelasjonListe(), FNR);
    ...
    public void inngaaendeKategoriNotat() throws DatatypeConfigurationException {
        DokumentMetadata dokumentMetadata = journalpostTransformer.dokumentMetadataFraJournalPost(InnsynImplTest.eksternDokumentinfoRelasjonListe(), FNR);
    ...
    public void sluttBrukerBlirIkkeSattTilTrue() throws DatatypeConfigurationException {
        DokumentMetadata dokumentMetadata = journalpostTransformer.dokumentMetadataFraJournalPost(InnsynImplTest.navMottattDokumentFraBruker(), "ikkesluttbruker");
