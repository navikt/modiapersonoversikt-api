...
object OppgaveOverstyring {
    ...
    val godkjenteInnkommendeOppgavetyper: List<String> = listOf("VURD_HENV", "KONT_BRUK", "VUR_KONS_YTE", "VUR_SVAR", "SVAR_IK_MOT")
    val allePrioriteter = listOf(HOY, NORM, LAV)

    val underkjenteTemaer: List<String> = listOf("OPA", "SAA", "IAR", "KNA", "OVR", "BII", "MOT", "TIL", "REK", "PER")

    val overstyrtKodeverk =
        LokalOverstyring.lagKodeverk {
