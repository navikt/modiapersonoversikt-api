...
import static no.nav.modiapersonoversikt.api.domain.Temagruppe.ARBD;
import static no.nav.modiapersonoversikt.api.domain.henvendelse.Meldingstype.SPORSMAL_SKRIFTLIG;
import static no.nav.modiapersonoversikt.api.domain.henvendelse.Meldingstype.SVAR_SKRIFTLIG;
import static no.nav.modiapersonoversikt.api.domain.henvendelse.Meldingstype.*;
import static no.nav.modiapersonoversikt.api.domain.henvendelse.Status.*;
import static no.nav.modiapersonoversikt.api.utils.MeldingUtils.*;
