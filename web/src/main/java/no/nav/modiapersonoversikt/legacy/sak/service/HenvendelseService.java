...
import no.nav.modiapersonoversikt.legacy.sak.providerdomain.Soknad;
...
import static no.nav.modiapersonoversikt.legacy.sak.providerdomain.Soknad.HenvendelseStatus.FERDIG;
import static no.nav.modiapersonoversikt.legacy.sak.transformers.Transformers.SOKNAD_TIL_KVITTERING;
import static no.nav.modiapersonoversikt.legacy.sak.transformers.Transformers.transformTilSoknad;
