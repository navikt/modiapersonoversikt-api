...
import { finnBehandlingsstatus, finnAntallBehandlingskjeder,
    underBehandlingEllerNyereEnnGrenseverdi } from './behandlingsstatus';
...
describe('Behandlingsstatus', () => {
    ...
    it('finnes ikke hvis ingen behandlingskjeder er under behandling eller ferdig behandlet', () => {
        ...
        const behandlingsstatus = finnBehandlingsstatus(behandlingskjeder, antallDagerFerdigBehandletStatusErGyldig);

        expect(behandlingsstatus).to.be.null;
    });
});
