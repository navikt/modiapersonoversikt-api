...
public class Sak implements Serializable, Comparable<Sak> {
    ...
    public static final List<String> GODKJENTE_TEMA_FOR_GENERELL_SAK = unmodifiableList(asList("AAP", "AGR", "BAR", "BIL", "DAG", "ENF", "ERS", "FEI", "FOR", "FOS", "FUL", "GEN", "GRA", "GRU", "HEL", "HJE", "IND", "KON", "KTR", "MED", "MOB", "OMS", "REH", "RVE", "RPO", "SAK", "SAP", "SER", "STO", "SUP", "SYK", "SYM", "TRK", "TRY", "TSR", "TSO", "UFM", "VEN", "YRA", "YRK", "FRI","PER", TEMAKODE_OPPFOLGING));
