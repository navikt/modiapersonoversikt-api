...
public final class StatiskeLenker {
    ...
    public static final String TJENESTER_BASE = getRequiredProperty("tjenester.url");
    ...
    public static final String NAV_NO = getRequiredProperty("dialogarena.navnolink.url");
