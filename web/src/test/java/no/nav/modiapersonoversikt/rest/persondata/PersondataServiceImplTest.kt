...
internal class PersondataServiceImplTest {
    ...
    internal fun `skal filtrere vekk ugyldig gt`() {
        val navEnhet = persondataServiceImpl.hentNavEnhetFraNorg(
            ...
            geografiskeTilknytning = PersondataResult.Success(PersondataResult.InformasjonElement.PDL_GT, ugyldigGT)
        )
    ...
    internal fun `skal gi navEnhet`() {
        ...
        val navEnhet = persondataServiceImpl.hentNavEnhetFraNorg(
            adressebeskyttelse = emptyList(),
            geografiskeTilknytning = PersondataResult.Success(PersondataResult.InformasjonElement.PDL_GT, gyldigGT)
        )
