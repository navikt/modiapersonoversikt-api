...
import static no.nav.modiapersonoversikt.integration.sykmeldingsperioder.consumer.utbetalinger.Transformers.TO_HOVEDYTELSE;
import static no.nav.modiapersonoversikt.integration.sykmeldingsperioder.consumer.utbetalinger.UtbetalingUtils.fjernHistoriskUtbetalingerMedFeilUtbetalingsType;
import static no.nav.modiapersonoversikt.integration.sykmeldingsperioder.consumer.utbetalinger.UtbetalingUtils.utbetalingInnenforSokeperioden;
