package no.nav.modiapersonoversikt.integration.personsok.consumer.fim.mapping;
...
import no.nav.modiapersonoversikt.integration.personsok.domain.Adresse;
import no.nav.modiapersonoversikt.integration.personsok.domain.Kodeverkstype;
