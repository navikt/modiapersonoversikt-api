...
class DialogMerkController
    ...
    constructor(
        ...
        fun merkSomFeilsendt(
            @RequestBody request: MerkSomFeilsendtRequest,
        ): ResponseEntity<Void> {
            val auditIdentifier =
                arrayOf(
        ...
        fun sendTilSladding(
            @RequestBody request: SendTilSladdingRequest,
        ): ResponseEntity<Void> {
            val auditIdentifier =
                arrayOf(
                    AuditIdentifier.FNR to request.fnr,
        ...
        fun lukkTraad(
            @RequestBody request: LukkTraadRequest,
        ): ResponseEntity<Void> {
            val auditIdentifier =
                arrayOf(
                    AuditIdentifier.FNR to request.fnr,
        ...
        fun avsluttGosysOppgave(
            @RequestBody request: AvsluttGosysOppgaveRequest,
        ): ResponseEntity<Void> {
            val auditIdentifier =
                arrayOf(
                    AuditIdentifier.FNR to request.fnr,
