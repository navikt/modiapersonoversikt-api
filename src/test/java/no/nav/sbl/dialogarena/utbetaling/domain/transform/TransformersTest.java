...
public class TransformersTest {
    ...
    public void hovedytelseTransformererKorrektFraWSObjekt() {
        WSUtbetaling wsUtbetaling = new WSUtbetaling()
                ...
                .withUtbetaltTilKonto(new WSBankkonto().withKontotype("Bankkonto").withKontonummer("112233112233"))
                ...
                .withYtelseListe(
                        new WSYtelse()
                                ...
                                .withRettighetshaver(new WSPerson().withAktoerId("112233445566").withNavn("Kari Normann").withDiskresjonskode("3"))
        ...
        assertThat(ytelse.get(Hovedytelse.utbetaltTilKonto), is("112233112233"));
