...
public class BesvarSporsmal {
	...
	public static void besvar(AppContext context, Record<ISvar> svar) {
	...
	public static BehandlingAvsluttet avsluttmelding(Record<SporsmalOgSvar> eksisterende, Record<ISvar> svar) {
