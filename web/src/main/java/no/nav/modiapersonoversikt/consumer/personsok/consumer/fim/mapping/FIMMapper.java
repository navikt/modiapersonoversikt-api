...
import no.nav.modiapersonoversikt.consumer.personsok.domain.Adresse;
import no.nav.modiapersonoversikt.consumer.personsok.domain.Kodeverkstype;
import no.nav.modiapersonoversikt.consumer.personsok.domain.Person;
