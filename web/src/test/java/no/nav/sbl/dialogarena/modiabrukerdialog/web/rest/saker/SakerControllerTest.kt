...
internal class SakerControllerTest {
    ...
    private val sakerController = SakerController(saksoversiktService, sakstemaService, saksService, tilgangskontrollService, unleashService)
    ...
    fun `Tester at man ikke har tilgang ved manipukert cookie`() {
        ...
        assertFailsWith<NotAuthorizedException> { sakerController.hent(request, "") }
    }
}