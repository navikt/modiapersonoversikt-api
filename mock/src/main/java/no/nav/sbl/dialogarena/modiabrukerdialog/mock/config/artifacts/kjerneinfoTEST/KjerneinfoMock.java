...
import static no.nav.sbl.dialogarena.modiabrukerdialog.mock.config.artifacts.kjerneinfoTEST.BehandleBrukerprofilServiceBiMock.getBehandleBrukerprofilServiceBiMock;
import static no.nav.sbl.dialogarena.modiabrukerdialog.mock.config.artifacts.kjerneinfoTEST.BrukerprofilServiceBiMock.getBrukerprofilServiceBiMock;
import static no.nav.sbl.dialogarena.modiabrukerdialog.mock.config.artifacts.kjerneinfoTEST.KodeverkmanagerBiMock.getKodeverkmanagerBiMock;
import static no.nav.sbl.dialogarena.modiabrukerdialog.mock.config.artifacts.kjerneinfoTEST.PersonKjerneinfoServiceBiMock.getPersonKjerneinfoServiceBiMock;
import static no.nav.sbl.dialogarena.modiabrukerdialog.mock.config.artifacts.kjerneinfoTEST.SykepengerWidgetServiceMock.getSykepengerWidgetServiceMock;
