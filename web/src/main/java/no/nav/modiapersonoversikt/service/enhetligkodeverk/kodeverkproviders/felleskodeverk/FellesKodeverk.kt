...
object FellesKodeverk {
    class Provider(
        ...
        private val fellesKodeverk: KodeverkApi = createKodeverkApi(machineToMachineTokenClient),
    ...
    internal fun createKodeverkApi(machineToMachineTokenClient: MachineToMachineTokenClient): KodeverkApi {
        ...
        val scope = DownstreamApi.parse(EnvironmentUtils.getRequiredProperty("FELLES_KODEVERK_SCOPE"))
