...
class DialogOppgaveController @Autowired constructor(
    ...
    @PostMapping("/opprett")
    fun opprettOppgave(@RequestBody request: OpprettOppgaveRequestDTO): OpprettOppgaveResponsDTO {
    ...
    fun opprettSkjermetOppgave(@RequestBody request: OpprettSkjermetOppgaveDTO
        ...
        return tilgangskontroll
                ...
                .get(Audit.describe(CREATE, Henvendelse.Oppgave.Opprett, AuditIdentifier.FNR to request.fnr)) {
                    oppgavebehandling.opprettSkjermetOppgave(OpprettOppgaveRequest(
                            fnr = request.fnr,
...
fun OpprettOppgaveRequestDTO.fromDTO() : OpprettOppgaveRequest = TODO();
fun OpprettOppgaveResponse.toDTO() : OpprettOppgaveResponsDTO = TODO();
fun OpprettSkjermetOppgaveDTO.fromDTO() : OpprettOppgaveRequest = TODO();
