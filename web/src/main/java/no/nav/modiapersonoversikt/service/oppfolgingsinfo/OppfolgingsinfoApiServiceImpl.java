...
import no.nav.modiapersonoversikt.api.domain.oppfolgingsinfo.rest.OppfolgingsEnhetOgVeileder;
import no.nav.modiapersonoversikt.api.domain.oppfolgingsinfo.rest.OppfolgingsStatus;
import no.nav.modiapersonoversikt.api.domain.oppfolgingsinfo.rest.Oppfolgingsenhet;
