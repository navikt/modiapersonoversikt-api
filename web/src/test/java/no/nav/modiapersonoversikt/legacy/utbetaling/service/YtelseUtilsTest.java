...
import no.nav.modiapersonoversikt.legacy.utbetaling.domain.util.YtelseUtils;
...
import static no.nav.modiapersonoversikt.legacy.utbetaling.domain.util.DateUtils.intervalFromStartEndDate;
import static no.nav.modiapersonoversikt.legacy.utbetaling.domain.util.YtelseUtils.*;
