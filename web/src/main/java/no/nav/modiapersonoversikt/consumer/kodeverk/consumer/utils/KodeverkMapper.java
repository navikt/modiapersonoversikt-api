package no.nav.modiapersonoversikt.consumer.kodeverk.consumer.utils;

import no.nav.modiapersonoversikt.legacy.kjerneinfo.common.domain.Periode;
import no.nav.modiapersonoversikt.consumer.kodeverk.consumer.fim.kodeverk.to.informasjon.*;
import no.nav.modiapersonoversikt.consumer.kodeverk.consumer.fim.kodeverk.to.meldinger.FinnKodeverkListeResponse;
import no.nav.modiapersonoversikt.consumer.kodeverk.consumer.fim.kodeverk.to.meldinger.HentKodeverkRequest;
import no.nav.modiapersonoversikt.consumer.kodeverk.consumer.fim.kodeverk.to.meldinger.HentKodeverkResponse;
...
public class KodeverkMapper {
	...
	public FinnKodeverkListeResponse map(XMLFinnKodeverkListeResponse xmlResponse) {
		...
		Map<String, no.nav.modiapersonoversikt.consumer.kodeverk.consumer.fim.kodeverk.to.informasjon.Kodeverk> kodeverksliste = new HashMap<>();
	...
	public no.nav.modiapersonoversikt.consumer.kodeverk.consumer.fim.kodeverk.to.informasjon.Kodeverk map(Kodeverk xmlKodeverk) {
		if (xmlKodeverk == null) {
			return null;
		}
		no.nav.modiapersonoversikt.consumer.kodeverk.consumer.fim.kodeverk.to.informasjon.Kodeverk kodeverk = new no.nav.modiapersonoversikt.consumer.kodeverk.consumer.fim.kodeverk.to.informasjon.Kodeverk();
