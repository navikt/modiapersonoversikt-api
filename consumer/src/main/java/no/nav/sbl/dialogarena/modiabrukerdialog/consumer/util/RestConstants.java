...
public class RestConstants {
    ...
    public static final String PERSONDOKUMENTER_BASEURL = System.getProperty("PERSON_OPPSLAG_V1_URL");
    ...
    public static final String SECURITY_TOKEN_SERVICE_BASEURL = System.getProperty("SECURITY_TOKEN_SERVICE_TOKEN_URL");
    ...
    public static final String SAF_GRAPHQL_BASEURL = System.getProperty("SAF_GRAPHQL_URL");
    public static final String SAF_HENTDOKUMENT_BASEURL = System.getProperty("SAF_HENTDOKUMENT_URL");
}
