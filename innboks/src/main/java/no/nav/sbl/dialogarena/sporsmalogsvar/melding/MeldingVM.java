...
public class MeldingVM implements Serializable {
    ...
    public static final DateTimeFormatter DATE_FORMATTER_DEFAULT = DateTimeFormat.forPattern("dd.MM.yyyy, HH:mm:ss")
    ...
    public String getOpprettetDato() {
        return DATE_FORMATTER_DEFAULT.print(melding.opprettet);
    }
