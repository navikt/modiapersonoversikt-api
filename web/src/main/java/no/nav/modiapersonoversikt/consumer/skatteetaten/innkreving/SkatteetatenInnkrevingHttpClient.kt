...
class SkatteetatenInnkrevingHttpClient(
    ...
    override fun ping(): SelfTestCheck = SelfTestCheck("SkatteetatenInnkrevingHttpClient", false) {
        // Midlertidig ping som kun fungerer i test.
        getKravdetaljer(
            "99ea4fbc-9777-4fdf-8d8d-75c76a5a45e0", KravidentifikatorType.SKATTEETATENS_KRAVIDENTIFIKATOR
        ).fold(
