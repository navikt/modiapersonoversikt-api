package no.nav.modiapersonoversikt.consumer.personsok.domain.personsok;

import no.nav.modiapersonoversikt.consumer.personsok.domain.*;
import no.nav.modiapersonoversikt.consumer.personsok.domain.enums.AdresseType;
import no.nav.modiapersonoversikt.consumer.personsok.domain.enums.Diskresjonskode;
import no.nav.modiapersonoversikt.consumer.personsok.domain.enums.PersonstatusType;
import no.nav.modiapersonoversikt.consumer.personsok.domain.factory.PersonsokDoFactory;
