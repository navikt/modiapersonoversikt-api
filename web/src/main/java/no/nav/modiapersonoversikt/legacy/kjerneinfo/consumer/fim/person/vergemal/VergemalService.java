...
public class VergemalService {
    ...
    public List<no.nav.modiapersonoversikt.legacy.kjerneinfo.consumer.fim.person.vergemal.domain.Verge> hentVergemal(String fodselsnummer) {
    ...
    private no.nav.modiapersonoversikt.legacy.kjerneinfo.consumer.fim.person.vergemal.domain.Verge lagVergeDomeneObjekt(Verge verge, Map<String, HentNavnBolk.Navn> vergeNavn) {
        String ident = getIdentFromVerge(verge);
        HentNavnBolk.Navn navn = vergeNavn.get(getIdentFromVerge(verge));

        return new no.nav.modiapersonoversikt.legacy.kjerneinfo.consumer.fim.person.vergemal.domain.Verge()
