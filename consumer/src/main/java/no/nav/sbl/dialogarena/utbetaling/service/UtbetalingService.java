...
public class UtbetalingService {
    ...
    public List<Utbetaling> hentUtbetalinger(String fnr){
        ...
        Utbetaling utbetaling4 = new UtbetalingBuilder().setPeriode("2010.03.23-2011.03.24").setNettoBelop(3000.0).setStatuskode("12").setBeskrivelse("Barnepenger").setUtbetalingsDato(new DateTime().now().minusDays(10)).createUtbetaling();
        ...
        Utbetaling utbetaling6 = new UtbetalingBuilder().setPeriode("2010.05.23-2011.05.24").setNettoBelop(5100.0).setStatuskode("12").setBeskrivelse("APGrunnbeløp").setUtbetalingsDato(new DateTime().now().minusDays(84)).createUtbetaling();
