...
public class KodeverkV2EndpointConfig {
    ...
    public KodeverkPortType kodeverkPortType() {
        KodeverkPortType portType = new KodeverkV2PortTypeImpl(endpoint).kodeverkPortType();
    ...
    public KodeverkClient kodeverkClient() {
        KodeverkClient kodeverkKlient = new KodeverkV2PortTypeImpl(endpoint).kodeverkClient();
