...
import no.nav.modiapersonoversikt.legacy.sak.service.filter.FilterUtils.fjernGamleDokumenter
...
internal class FilterUtilsTest {
    ...
    private fun getMockSaksteman(): List<Sakstema> {
        ...
        val dokumentmetadata6 = DokumentMetadata()
            .withJournalpostId("6")
            .withBaksystem(Baksystem.HENVENDELSE).withBaksystem(Baksystem.SAF)
            .withDato(LocalDateTime.of(2015, Month.APRIL, 8, 12, 30))
