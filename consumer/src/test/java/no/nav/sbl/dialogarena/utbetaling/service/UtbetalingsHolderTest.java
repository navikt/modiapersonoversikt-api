...
public class UtbetalingsHolderTest {
    ...
    @InjectMocks
    private UtbetalingsHolder utbetalingsHolder = new UtbetalingsHolder();

    @Before
    public void setUp() {
        utbetalingsHolder.withFnr(FNR);
    }
    ...
    public void finnUtbetalingerIPeriode_AlleUtbetalingerInnenfor() throws Exception {
        ...
        DateTime periodeStart = now().minusDays(15);
        DateTime periodeSlutt = now().minusDays(1);
