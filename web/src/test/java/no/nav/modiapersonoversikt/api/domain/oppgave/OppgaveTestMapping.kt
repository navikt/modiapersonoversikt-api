...
import no.nav.modiapersonoversikt.api.domain.oppgave.generated.models.*
...
public fun OppgaveJsonDTO.toPostOppgaveResponseJsonDTO(): PostOppgaveResponseJsonDTO =
    PostOppgaveResponseJsonDTO(
        ...
        status =
        no.nav.modiapersonoversikt.api.domain.oppgave.OppgaveMappingHelpers.convertEnumToPostResp(this.status),
        prioritet =
        no.nav.modiapersonoversikt.api.domain.oppgave.OppgaveMappingHelpers.convertEnumToPostResp(this.prioritet)
    )
...
public fun OppgaveJsonDTO.toGetOppgaveResponseJsonDTO(): GetOppgaveResponseJsonDTO =
    GetOppgaveResponseJsonDTO(
        ...
        endretTidspunkt = this.endretTidspunkt,
        status =
        no.nav.modiapersonoversikt.api.domain.oppgave.OppgaveMappingHelpers.convertEnumToGetResp(this.status),
        prioritet =
        no.nav.modiapersonoversikt.api.domain.oppgave.OppgaveMappingHelpers.convertEnumToGetResp(this.prioritet)
    )
...
public fun OppgaveJsonDTO.toPutOppgaveResponseJsonDTO(): PutOppgaveResponseJsonDTO =
    PutOppgaveResponseJsonDTO(
        ...
        endretTidspunkt = this.endretTidspunkt,
        status =
        no.nav.modiapersonoversikt.api.domain.oppgave.OppgaveMappingHelpers.convertEnumToPutResp(this.status),
        prioritet =
        no.nav.modiapersonoversikt.api.domain.oppgave.OppgaveMappingHelpers.convertEnumToPutResp(this.prioritet)
    )
