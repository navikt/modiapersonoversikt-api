...
public class RestConfig extends ResourceConfig {
    ...
    public RestConfig() {
        super(JacksonConfig.class, SkrivestotteController.class, MeldingerController.class, JournalforingController.class, VarslerController.class, SaksoversiktController.class);
    }
}
