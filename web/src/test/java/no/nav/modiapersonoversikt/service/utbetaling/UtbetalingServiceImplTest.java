...
import static no.nav.modiapersonoversikt.service.utbetaling.domain.testdata.WSUtbetalingTestData.createKariNordmannUtbetaling;
import static no.nav.modiapersonoversikt.service.utbetaling.domain.testdata.WSUtbetalingTestData.createUtbetalingMedValgtUtbetalingsdatoForfallsdatoOgPosteringsdato;
import static no.nav.modiapersonoversikt.service.utbetaling.domain.util.DateUtils.EKSTRA_SOKEPERIODE;
import static no.nav.modiapersonoversikt.service.utbetaling.domain.util.YtelseUtils.getHovedytelseListe;
