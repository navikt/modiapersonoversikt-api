package no.nav.modiapersonoversikt.consumer.personsok.consumer.config;

import no.nav.modiapersonoversikt.consumer.personsok.consumer.fim.kodeverk.KodeverkManager;
import no.nav.modiapersonoversikt.consumer.personsok.consumer.fim.kodeverk.support.DefaultKodeverkManager;
import no.nav.modiapersonoversikt.consumer.personsok.consumer.fim.kodeverk.support.KodeverkServiceDelegate;
...
import no.nav.modiapersonoversikt.consumer.personsok.consumer.fim.personsok.support.DefaultPersonsokService;
