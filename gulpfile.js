...
var config = {
    srcPath: "./src/main/resources/no/nav/sbl/dialogarena/varsel/",
    targetPath: "./target/classes/no/nav/sbl/dialogarena/varsel/build/"
}
...
var browserifyTask = function (isDev) {
    ...
    props.entries = ['./src/main/resources/no/nav/sbl/dialogarena/varsel/varsel-module.js'];
    props.debug = isDev;
    props.cache = {};
    props.packageCache = {};
