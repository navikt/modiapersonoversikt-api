...
public class FIMKodeverkMapperTest {
    ...
    public void testFinnkodeverklisteResponse() {
        ...
        no.nav.modiapersonoversikt.consumer.kodeverk.consumer.fim.kodeverk.to.meldinger.FinnKodeverkListeResponse to = mapper.map(from);
    ...
    public void hentKodeverkRequest() {
        no.nav.modiapersonoversikt.consumer.kodeverk.consumer.fim.kodeverk.to.meldinger.HentKodeverkRequest from = new no.nav.modiapersonoversikt.consumer.kodeverk.consumer.fim.kodeverk.to.meldinger.HentKodeverkRequest();
        from.setNavn("navn1");
    ...
    public void hentKodeverkResponse() {
        ...
        no.nav.modiapersonoversikt.consumer.kodeverk.consumer.fim.kodeverk.to.meldinger.HentKodeverkResponse to = mapper.map(from);
    ...
    public void kode() {
        ...
        no.nav.modiapersonoversikt.consumer.kodeverk.consumer.fim.kodeverk.to.informasjon.Kode to = mapper.map(from);
    ...
    public void finnKodeverk() {
        ...
        no.nav.modiapersonoversikt.consumer.kodeverk.consumer.fim.kodeverk.to.informasjon.Kodeverk to = mapper.map(from);
    ...
    public void enkeltKodeverk() {
        ...
        no.nav.modiapersonoversikt.consumer.kodeverk.consumer.fim.kodeverk.to.informasjon.EnkeltKodeverk to = mapper.map(from);
