package no.nav.personsok.consumer.mdc;
 ...
 *
 * Putter informasjon om tråd i en egen map, slik at dette kan puttes i logg dersom tråden feiler. For personsøk
 * er informasjonen relatert til logging av tjenstekall.
 */
