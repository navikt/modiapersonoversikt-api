...
import no.nav.modiapersonoversikt.legacy.utbetaling.config.ApplicationTestConfig;
import no.nav.modiapersonoversikt.legacy.utbetaling.config.UtbetalingPortTypeTestConfig;
