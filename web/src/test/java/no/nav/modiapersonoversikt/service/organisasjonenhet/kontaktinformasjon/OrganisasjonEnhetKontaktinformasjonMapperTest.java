package no.nav.modiapersonoversikt.service.organisasjonenhet.kontaktinformasjon;


import no.nav.modiapersonoversikt.service.organisasjonenhet.kontaktinformasjon.domain.*;
import no.nav.modiapersonoversikt.service.organisasjonenhet.kontaktinformasjon.service.OrganisasjonEnhetKontaktinformasjonMapper;
...
class OrganisasjonEnhetKontaktinformasjonMapperTest {
    ...
    class AdresseTester {
        ...
        void adresseMapping() {
            ...
            Gateadresse besoeksadresse = organisasjonEnhetKontaktinformasjon.getKontaktinformasjon().getPublikumsmottak().get(0).getBesoeksadresse();
