package no.nav.modiapersonoversikt.integration.personsok.domain.personsok;

import no.nav.modiapersonoversikt.integration.personsok.domain.*;
import no.nav.modiapersonoversikt.integration.personsok.domain.enums.AdresseType;
import no.nav.modiapersonoversikt.integration.personsok.domain.enums.Diskresjonskode;
import no.nav.modiapersonoversikt.integration.personsok.domain.enums.PersonstatusType;
import no.nav.modiapersonoversikt.integration.personsok.domain.factory.PersonsokDoFactory;
