package no.nav.modiapersonoversikt.integration.kontrakter.consumer.config;

import no.nav.modiapersonoversikt.integration.kontrakter.consumer.fim.config.OppfolgingskontraktConsumerConfig;
import no.nav.modiapersonoversikt.integration.kontrakter.consumer.fim.config.YtelseskontraktConsumerConfig;
import no.nav.modiapersonoversikt.integration.kontrakter.consumer.fim.mapping.YtelseskontraktMapper;
import no.nav.modiapersonoversikt.integration.kontrakter.consumer.fim.oppfolgingskontrakt.OppfolgingskontraktServiceBi;
import no.nav.modiapersonoversikt.integration.kontrakter.consumer.fim.oppfolgingskontrakt.support.DefaultOppfolgingskontraktService;
import no.nav.modiapersonoversikt.integration.kontrakter.consumer.fim.ytelseskontrakt.YtelseskontraktServiceBi;
import no.nav.modiapersonoversikt.integration.kontrakter.consumer.fim.ytelseskontrakt.support.DefaultYtelseskontraktService;
import no.nav.modiapersonoversikt.integration.kontrakter.consumer.utils.OppfolgingskontraktMapper;
