...
public interface Kodeverk {
     ...
     */
    enum Nokkel {
        SKJEMANUMMER, GOSYS_ID, TEMA, TITTEL, TITTEL_EN, TITTEL_NN, BESKRIVELSE, URL, URLENGLISH, URLNEWNORWEGIAN, URLPOLISH, URLFRENCH, URLSPANISH, URLGERMAN, URLSAMISK,  VEDLEGGSID
    }
}
