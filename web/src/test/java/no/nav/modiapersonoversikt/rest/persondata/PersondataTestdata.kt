...
internal val digitalKontaktinformasjon = DigDir.DigitalKontaktinformasjon(
    personident = "12345678910",
    reservasjon = null,
    epostadresse = DigDir.Epostadresse(value = "test@test.no"),
    mobiltelefonnummer = DigDir.MobilTelefon(value = "90009900")
)
...
internal val testData = PersondataFletter.Data(
    ...
    digDirData = PersondataResult.runCatching(InformasjonElement.DKIF) { digitalKontaktinformasjon },
